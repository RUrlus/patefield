...
IF (PATEFIELD_ENABLE_ARCH_FLAGS)
    MESSAGE(STATUS "patefield: Building for native host")
    INCLUDE(OptimizeForArchitecture)
    OptimizeForArchitecture()
ELSEIF (PATEFIELD_ENABLE_ARCH_FLAGS_SIMPLE)
    MESSAGE(STATUS "patefield: Building for native host")
    INCLUDE(SimpleOptimizeForArchitecture)
ELSE ()
    SET(PATEFIELD_ARCHITECTURE_FLAGS "")
    MESSAGE(STATUS "patefield: Building for non-native host")
ENDIF()


IF (PATEFIELD_COVERAGE)
